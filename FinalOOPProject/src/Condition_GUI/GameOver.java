...
public class GameOver extends GameScene implements SMethods {

    private Buttons bReplay, bMenu;

    public GameOver(MainGUI game) {
        super(game);
        initButtons();
    }
    ...
    private void initButtons() {
        ...
        bMenu = new Buttons("Menu", x, y, w, h);
        bReplay = new Buttons("Replay", x, y + yOffset, w, h);
    ...
    private void resetAll() {
        game.getInPlay().resetEverything();
    }
